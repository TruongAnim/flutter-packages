...
+ (instancetype)makeWithAsset:(nullable NSString *)asset
    ...
    hlsCacheConfig:(NSDictionary<NSString *, NSString *> *)hlsCacheConfig {
  ...
  pigeonResult.hlsCacheConfig = hlsCacheConfig;
  return pigeonResult;
}
+ (FVPCreationOptions *)fromList:(NSArray<id> *)list {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  ...
  pigeonResult.hlsCacheConfig = GetNullableObjectAtIndex(list, 5);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.hlsCacheConfig ?: [NSNull null],
  ];
}
@end
...
void SetUpFVPAVFoundationVideoPlayerApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPAVFoundationVideoPlayerApi> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.preCache", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(preCache:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(preCache:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        FVPCreationOptions *arg_preCacheMsg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        NSNumber *output = [api preCache:arg_preCacheMsg error:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.isCached", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(isCached:position:length:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(isCached:position:length:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSString *arg_cacheKey = GetNullableObjectAtIndex(args, 0);
        NSInteger arg_position = [GetNullableObjectAtIndex(args, 1) integerValue];
        NSInteger arg_length = [GetNullableObjectAtIndex(args, 2) integerValue];
        FlutterError *error;
        NSNumber *output = [api isCached:arg_cacheKey position:arg_position length:arg_length error:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.initCache", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(initCache:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(initCache:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_maxCacheSize = [GetNullableObjectAtIndex(args, 0) integerValue];
        FlutterError *error;
        [api initCache:arg_maxCacheSize error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
