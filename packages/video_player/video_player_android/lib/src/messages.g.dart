...
class CreateMessage {
  ...
  static CreateMessage decode(Object result) {
    ...
    return CreateMessage(
      ...
      bufferingConfig: (result[6] as Map<Object?, Object?>?)!.cast<String?, String?>(),
    );
  }
}
...
class AndroidVideoPlayerApi {
  ...
  Future<bool> isCached(IsCacheMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<void> initCache(int arg_maxCacheSize) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.initCache', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_maxCacheSize]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
