...
class IsCacheMessage {
  ...
  static IsCacheMessage decode(Object result) {
    result as List<Object?>;
    return IsCacheMessage(
      cacheKey: result[0]! as String,
...
class CreateMessage {
  ...
  static CreateMessage decode(Object result) {
    ...
    return CreateMessage(
      ...
      hlsCacheConfig: (result[4] as Map<Object?, Object?>?)!.cast<String?, String?>(),
      bufferingConfig: (result[5] as Map<Object?, Object?>?)!.cast<String?, String?>(),
...
class AndroidVideoPlayerApi {
  ...
  Future<PreCacheMessage> preCache(CreateMessage msg) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.preCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as PreCacheMessage?)!;
    }
  }

  Future<bool> isCached(IsCacheMessage msg) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.isCached$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> initCache(int maxCacheSize) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.initCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
